class ReferralsController < ApplicationController
  ...
  private
    ...
    def referral_params
      params.require(:referral).permit(:navcolor, :rheadline, :rheadlinecolor, :rbackgroundcolor, :rboxcolor, :rcountcolor, :rhow, :rhowcolor, :rightheadline, :rightsub, :rightcolor, :bottomsub, :reward1, :reward2, :reward3, :reward4)
    end
end
